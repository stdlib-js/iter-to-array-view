...
```javascript
import iterator2arrayview from 'https://cdn.jsdelivr.net/gh/stdlib-js/iter-to-array-view@v0.1.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/iter-to-array-view/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/iter-to-array-view/actions/workflows/test.yml?query=branch:v0.1.0
