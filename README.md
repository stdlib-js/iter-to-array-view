...
```javascript
iterator2arrayview = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/iter-to-array-view@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/iter-to-array-view@umd/bundle.js"></script>
```
