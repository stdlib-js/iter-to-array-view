...
```javascript
import iterator2arrayview from 'https://cdn.jsdelivr.net/gh/stdlib-js/iter-to-array-view@v0.1.0-deno/mod.js';
```
...
[@stdlib/iter/to-array-view-right]: https://github.com/stdlib-js/iter-to-array-view-right/tree/deno
